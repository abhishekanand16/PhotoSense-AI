...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "pydantic", "pydantic_core", "pydantic.deprecated", "pydantic.deprecated.decorator",
        ...
        "transformers.models.clip.configuration_clip", "transformers.models.clip.tokenization_clip",
        "transformers.models.auto", "transformers.models.auto.modeling_auto",
        "transformers.models.auto.processing_auto", "transformers.models.auto.configuration_auto",
        ...
        "safetensors", "safetensors.torch", "accelerate", "timm", "timm.models", "timm.layers", "einops",
        ...
        "ultralytics.utils", "ultralytics.engine", "ultralytics.engine.results", "ultralytics.data",
        
        # Image Format Support
        "pillow_heif", "exifread",
        
        # Async HTTP (Geocoding)
        "aiohttp", "aiofiles", "multidict", "yarl", "async_timeout", "frozenlist", "aiosignal",
        
        # Utilities
        "tqdm", "tqdm.auto", "requests", "urllib3", "certifi", "charset_normalizer",
        "idna", "packaging", "packaging.version", "filelock", "fsspec", "regex",
        "tokenizers", "sentencepiece",
        
        # Services Modules (PhotoSense-AI)
        "services", "services.api", "services.api.main", "services.api.models",
        "services.api.routes", "services.api.routes.faces", "services.api.routes.models",
        "services.api.routes.objects", "services.api.routes.people", "services.api.routes.pets",
        "services.api.routes.photos", "services.api.routes.places", "services.api.routes.scan",
        "services.api.routes.scenes", "services.api.routes.search", "services.api.routes.stats",
        "services.api.routes.tags", "services.config", "services.logging_config",
        "services.ml", "services.ml.pipeline", "services.ml.storage",
        "services.ml.storage.sqlite_store", "services.ml.storage.faiss_index",
        "services.ml.detectors", "services.ml.detectors.face_detector",
        "services.ml.detectors.object_detector", "services.ml.detectors.scene_detector",
        "services.ml.detectors.clip_scene_detector", "services.ml.detectors.florence_detector",
        "services.ml.embeddings", "services.ml.embeddings.face_embedding",
        "services.ml.embeddings.image_embedding", "services.ml.utils",
        "services.ml.utils.exif_utils", "services.ml.utils.geocoder",
        "services.ml.utils.image_cache", "services.ml.utils.model_tracker",
        "services.ml.utils.path_utils", "services.ml.utils.search_utils",
    ],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
