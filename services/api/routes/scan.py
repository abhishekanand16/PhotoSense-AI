...
async def process_folder_async(folder_path: str, recursive: bool, job_id: str):
    ...
    try:
        ...
        for batch_start in range(0, total_to_process, BATCH_SIZE):
            ...
            progress = 0.5 + batch_end / total_to_process * 0.5 if total_to_process > 0 else 1.0
            _update_job(job_id, progress=progress, message=f"Scanning faces... {batch_end}/{total_to_process}")
